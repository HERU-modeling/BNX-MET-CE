...
# Fatal overdoses
tbl_df_summ_inc_odf_psa_itt_rr_sa <- df_incremental_psa_itt_rr_sa_scaled %>%
  as_tibble() %>%
  select(
    n_inc_odf_adj_2010_scaled,
    n_inc_odf_adj_2012_scaled,
...
# Non-fatal overdoses
tbl_df_summ_inc_odn_psa_itt_rr_sa <- df_incremental_psa_itt_rr_sa_scaled %>%
  as_tibble() %>%
  select(
    n_inc_odn_adj_2010_scaled,
    n_inc_odn_adj_2012_scaled,
...
# All-cause deaths
tbl_df_summ_inc_acm_psa_itt_rr_sa <- df_incremental_psa_itt_rr_sa_scaled %>%
  as_tibble() %>%
  select(
    n_inc_acm_adj_2010_scaled,
    n_inc_acm_adj_2012_scaled,
