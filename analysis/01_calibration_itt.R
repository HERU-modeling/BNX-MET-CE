...
l_cali_targets <- list(
  ...
  df_oot = subset(df_cali_targets, target == "time out of treatment (itt)"),
...
l_fit_imis <- IMIS::IMIS(
  B = 100, # (incremental sample size at each iteration of IMIS)
...
save(df_cali_stats,
  ...
  v_calib_post_mean,
  df_posterior_summ,
  file = "outputs/calibration/itt/imis_output_itt.RData"
)

## As .csv
write.csv(df_cali_stats,
  file = "outputs/calibration/itt/cali_stats_itt.csv",
  row.names = FALSE
)
write.csv(df_posterior_summ,
  file = "outputs/calibration/itt/summary_posterior_itt.csv",
  row.names = FALSE
)
...
png("plots/calibration/itt/posterior_distribution_marginal.png",
...
# Load posterior
load(file = "outputs/calibration/itt/imis_output_itt.RData")
...
ggsave(prior_v_posterior,
  filename = "plots/calibration/itt/prior-v-posterior.png",
  width = 10, height = 7
)
t_cali_end <- Sys.time()
...
save(m_outcomes_odf_comb,
  file = "outputs/calibration/itt/model_targets_odf_itt.RData"
)
save(m_outcomes_dno_comb,
  file = "outputs/calibration/itt/model_targets_dno_itt.RData"
)
save(m_outcomes_odn_comb,
  file = "outputs/calibration/itt/model_targets_odn_itt.RData"
)
save(m_outcomes_oot_comb,
  file = "outputs/calibration/itt/model_targets_oot_itt.RData"
)
save(m_outcomes_abs_comb,
  file = "outputs/calibration/itt/model_targets_abs_itt.RData"
)

# Load data
load(file = "outputs/calibration/itt/model_targets_odf_itt.RData")
load(file = "outputs/calibration/itt/model_targets_dno_itt.RData")
load(file = "outputs/calibration/itt/model_targets_odn_itt.RData")
load(file = "outputs/calibration/itt/model_targets_oot_itt.RData")
load(file = "outputs/calibration/itt/model_targets_abs_itt.RData")
...
plot_fit_oot <- p_temp_oot + labs(title = NULL, x = "Year", y = "Time out of treatment") +
  theme_classic() +
  theme(legend.position = "none") +
  theme(legend.title = element_blank()) +
  theme(
...
# Outputs
# ggsave(plot_fit_odf,
#   filename = "plots/calibration/itt/target-fit-odf.png",
#   width = 4, height = 4
# )
# ggsave(plot_fit_dno,
#   filename = "plots/calibration/itt/target-fit-dno.png",
#   width = 4, height = 4
# )
# ggsave(plot_fit_odn,
#   filename = "plots/calibration/itt/target-fit-odn.png",
#   width = 4, height = 4
# )
# ggsave(plot_fit_oot,
#   filename = "plots/calibration/itt/target-fit-oot.png",
#   width = 4, height = 4
# )
# ggsave(plot_fit_abs,
#   filename = "plots/calibration/itt/target-fit-abs.png",
#   width = 4, height = 4
# )
# ggsave(plot_fit_comb,
#   filename = "plots/calibration/itt/target-fit-comb.png",
#   width = 6, height = 8
# )
ggsave(plot_fit_comb_all,
  filename = "plots/calibration/itt/target-fit-comb-all.png",
  width = 6, height = 6
)
...
write.csv(df_run_time,
  file = "outputs/calibration/itt/cali_run_time_itt.csv",
  row.names = TRUE
)
